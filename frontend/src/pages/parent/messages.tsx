                    ...
                    <div className="w-full flex justify-start items-center mt-5 mb-8 text-[#1b3c79]">
                        ...
                        <p className="w-[67%] h-[100px] rounded-4xl bg-[#FEF9F6] border-3 border-[#D58FFF] ml-25 text-center pt-3 pl-5 flex justify-end md:w-[85%] md:justify-center">
                            <span className="inline-block w-[90%] text-left pl-5 relative md:text-center md:pl-0 md:pr-25">
                                ...
                                {children && children.length > 1 && <img src="/admin/flechedroite.webp" alt="" width={40} title="enfant suivant" className="inline-block ml-10 absolute bottom-[-10] right-3 cursor-pointer" onClick={handleChildChange} />}
                            </span>
                        </p>
                    </div>
                }
                ...
                <div className="bg-[#FEF9F6] mx-2 rounded-[30px] border-3 border-[#D58FFF] flex flex-col shadow-2xl">
                    ...
                    <form onSubmit={handleSubmitForm} className="relative flex items-center text-[#1B3C79] bg-[#FEF9F6] rounded-[35px] border-3 border-[#D58FFF] px-6 py-2 mx-2 my-3" >
                        ...
                        <button type="submit" disabled={!messageToSend}>
                            <img src="/boutons/fleche.webp" width={40} className={`opacity-70 ${!messageToSend ? "cursor-not-allowed" : "cursor-pointer hover:opacity-100"}`} title="envoyer message" />
                        </button>
                    </form>
                </div>
            </div>
