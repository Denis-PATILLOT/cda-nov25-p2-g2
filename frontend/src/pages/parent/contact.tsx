...
const ContactDirectricePage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                alert(
                    "Succès ! Votre message et vos fichiers ont été envoyés.",
                );
                router.push("/parent");
            } else {
            ...
            alert(
                `Erreur : ${err.message || "Impossible d'envoyer le message"}`,
            );
        } finally {
            setLoading(false);
        }
            ...
            <div className="bb-screen">
                <div className="bb-mobile-container">
                    <main className="bb-main">
                        ...
                        <div
                            className="bb-profile-card"
                            style={{ paddingTop: "35px" }}
                        >
                            <form
                                onSubmit={handleSubmit}
                                className="bb-info-list"
                            >
                                {/* OBJET */}
                            ...
                            <p className="bb-notice-text">
                                Votre message sera envoyé directement à la boîte
