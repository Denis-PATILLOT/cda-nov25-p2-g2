...
export default function ReportPage() {
    ...
    return (
        <Layout pageTitle="Report">
            <div className="mx-auto flex min-h-screen w-full max-w-[430px] flex-col px-4 pb-28 pt-8 md:max-w-[75%]">
                    ...
                    {!isLoadingAny && !hasErrorAny && (
                        <>
                            {planningForChild ? (
                                ...
                                <div className="w-full rounded-2xl border-4 border-yellow-200 bg-white/80 p-5 text-blue-900 shadow-sm md:w-[75%] md:mx-auto md:mb-8">
                            ...
                            <StaffCommentCard
                                text={
                                    reportOfToday?.staff_comment ??
                                    "Aucun commentaire pour aujourd’hui."
                                }
