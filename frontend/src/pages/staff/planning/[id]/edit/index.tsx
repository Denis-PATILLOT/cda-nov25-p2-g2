...
const EditPlanningPage = () => {
  ...
  const { data, refetch, error } = useGetPlanningByIdQuery({
    variables: { getPlanningById: Number(id) },
  });

  // gestion du hook pour la mutation d'un planning
  const [updatePlanning, _loading] = useUpdatePlanningMutation({
    variables: { data: data as UpdatePlanningInput, updatePlanningId: Number(id) },
  });
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="w-[90%] mx-auto">
                ...
                <input
                  ...
                  defaultValue={planning.morning_activities!}
              ...
              <div className="w-[90%] mx-auto">
                ...
                <input
                  ...
                  id="morning_nap"
                  name="morning_nap"
                  defaultValue={planning.morning_nap!}
                  className="border-2 border-amber-300 bg-[#FEE8B6] p-2 rounded-lg w-full inline-block mt-1 mb-3"
                />
              </div>
              ...
              <div className="w-[90%] mx-auto">
                ...
                <input
                  ...
                  type="text"
                  defaultValue={planning.afternoon_activities!}
                  className="border-2 border-amber-300 bg-[#FEE8B6] p-2 rounded-lg w-full inline-block mt-1 mb-3"
                />
              </div>
              ...
              <div className="w-[90%] mx-auto">
                ...
                <input
                  ...
                  id="afternoon_nap"
                  name="afternoon_nap"
                  defaultValue={planning.afternoon_nap!}
                  className="border-2 border-amber-300 bg-[#FEE8B6] p-2 rounded-lg w-full inline-block mt-1 mb-3"
                />
              </div>
