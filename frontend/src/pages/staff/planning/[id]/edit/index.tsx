                    ...
                    <div className="w-[90%] px-4 py-1 bg-[#FEF9F6] rounded-2xl text-[#1b3c79] font-semibold mx-auto border-3 border-[#FFD771]">
                        <form onSubmit={handleSubmit}>
                            ...
                            <h1 className="m-2 mb-3">
                                <Image src="/boutons/calendrier.webp" alt="" width={35} height={25} className="inline-block m-2" />
                            ...
                            <div className="w-[90%] mx-auto">
                                <label htmlFor="morning_activities" className="w-[70%]inline-block">
                                    <Image src="/boutons/star.webp" alt="" width={20} height={20} className="inline-block" />Activité matin
                                </label>
                            ...
                            <div className="w-[90%] mx-auto">
                                <label htmlFor="morning_nap" className="w-[70%]inline-block">
                                    <Image src="/boutons/dormir.webp" alt="" width={20} height={20} className="inline-block" />Sieste matin
                                </label>
                            ...
                            <div className="w-[90%] mx-auto">
                                <label htmlFor="meal" className="w-[70%]inline-block">
                                    <Image src="/boutons/repas.webp" alt="" width={20} height={20} className="inline-block" />Repas midi
                                </label>
                            ...
                            <div className="w-[90%] mx-auto">
                                <label htmlFor="afternoon_activities" className="w-[70%]inline-block">
                                    <Image src="/boutons/star.webp" alt="" width={20} height={20} className="inline-block" />Activité après-midi
                                </label>
                            ...
                            <div className="w-[90%] mx-auto">
                                <label htmlFor="afternoon_nap" className="w-[70%]inline-block">
                                    <Image src="/boutons/dormir.webp" alt="" width={20} height={20} className="inline-block" />Sieste après-midi
                                </label>
                            ...
                            <div className="w-[90%] mx-auto">
                                <label htmlFor="snack" className="w-[70%]inline-block">
                                    <Image src="/boutons/gouter.webp" alt="" width={20} height={20} className="inline-block" />Goûter
                                </label>
