...
import {
    GetAllPlanningsByGroupDocument,
    PlanningInput,
...
const CreatePlanningPage = () => {
    ...
    const handleSubmitForm = async (data: PlanningInput) => {
        try {
            ...
            }); // relance de la requête pour récupérer les plannings avec le nouveau

            if (result) {
                const id = result.data!.createPlanning.id;
                router.push(
                    `/staff/planning/${id}?created=true`,
                    `/staff/planning/${id}`,
                );
            }
        } catch (err) {
                    ...
                    {errorSubmit && errors && (
                        <p className="text-red-500 px-5 mx-5 my-2 alert bg-red-100 border relative border-red-500 md:text-xl md:mb-5">
                            {CombinedGraphQLErrors.is(error) &&
                                ...
                                "INVALID DATE" &&
                                "Planning déjà existant pour cette date"}
                            {CombinedGraphQLErrors.is(error) &&
                                error.errors![0].extensions?.code !==
                                "INVALID DATE" &&
                                error.message}
                        ...
                        <form onSubmit={handleSubmit(handleSubmitForm)}>
                            ...
                            <h1 className="m-2 mb-3">
                                ...
                                <input
                                    ...
                                    id="date"
                                    name="date"
                                    className={`border-2 border-amber-300 bg-[#FEE8B6] p-2 rounded-lg w-full inline-block mt-1 mb-3 ${errors.date ? "focus-visible:outline-2 focus-visible:outline-red-500" : ""}`}
                                />
                                ...
                                <p className="text-red-500 mb-1 text-xs">
                                    {errors.date?.type === "validate" &&
                                        "choisir un jour de semaine valide"}
                                </p>
                            </h1>

                            <div className="w-[90%] mx-auto">
                                <label
                                    htmlFor="morning_activities"
                                ...
                                <input
                                    {...register("morning_activities", {
                                        required:
                                            "saisir les activités du matin",
                                        setValueAs: (value) => value.trim(),
                                    })}
                                    type="text"
                                    id="morning_activities"
                                    name="morning_activities"
                                    className={`border-2 border-amber-300 bg-[#FEE8B6] p-2 rounded-lg w-full inline-block mt-1 mb-3 ${errors.morning_activities ? "focus-visible:outline-2 focus-visible:outline-red-500" : ""}`}
                                />
                                <p className="text-red-500 mb-1 text-xs">
                                    {errors.morning_activities?.message}
                                </p>
                            </div>
                            ...
                            <div className="w-[90%] mx-auto">
                                ...
                                <input
                                    {...register("morning_nap", {
                                        required:
                                            "saisir la période de sieste du matin",
                                        setValueAs: (value) => value.trim(),
                                    })}
                                    type="text"
                                    id="morning_nap"
                                    name="morning_nap"
                                    className={`border-2 border-amber-300 bg-[#FEE8B6] p-2 rounded-lg w-full inline-block mt-1 mb-3  ${errors.morning_nap ? "focus-visible:outline-2 focus-visible:outline-red-500" : ""}`}
                                />
                                <p className="text-red-500 mb-1 text-xs">
                                    {errors.morning_nap?.message}
                                </p>
                            </div>
                            ...
                            <div className="w-[90%] mx-auto">
                                ...
                                <textarea
                                    ...
                                    id="meal"
                                    name="meal"
                                    className={`border-2 border-amber-300 bg-[#FEE8B6] p-2 rounded-lg w-full inline-block mt-1 mb-3 resize-none ${errors.morning_nap ? "focus-visible:outline-2 focus-visible:outline-red-500" : ""}`}
                                />
                                <p className="text-red-500 mb-1 text-xs">
                                    {errors.meal?.message}
                                </p>
                            ...
                            <div className="w-[90%] mx-auto">
                                ...
                                <input
                                    {...register("afternoon_activities", {
                                        required:
                                            "saisir les activités de l'après-midi",
                                        setValueAs: (value) => value.trim(),
                                    })}
                                    id="afternoon_activities"
                                    name="afternoon_activities"
                                    type="text"
                                    className={`border-2 border-amber-300 bg-[#FEE8B6] p-2 rounded-lg w-full inline-block mt-1 mb-3 ${errors.afternoon_activities ? "focus-visible:outline-2 focus-visible:outline-red-500" : ""}`}
                                />
                                <p className="text-red-500 mb-1 text-xs">
                                    {errors.afternoon_activities?.message}
                                </p>
                            </div>

                            <div className="w-[90%] mx-auto">
                                <label
                                    htmlFor="afternoon_nap"
                                    className="w-[70%]inline-block"
                                >
                                    <Image
                                        src="/boutons/dormir.webp"
                                ...
                                <input
                                    {...register("afternoon_nap", {
                                        required:
                                            "saisir la sieste de l'après-midi",
                                        setValueAs: (value) => value.trim(),
                                    })}
                                    type="text"
                                    id="afternoon_nap"
                                    name="afternoon_nap"
                                    className={`border-2 border-amber-300 bg-[#FEE8B6] p-2 rounded-lg w-full inline-block mt-1 mb-3 ${errors.afternoon_nap ? "focus-visible:outline-2 focus-visible:outline-red-500" : ""}`}
                                />
                                <p className="text-red-500 mb-1 text-xs">
                                    {errors.afternoon_nap?.message}
                                </p>
                            </div>
                            ...
                            <div className="w-[90%] mx-auto">
                                ...
                                <input
                                    ...
                                    id="snack"
                                    name="snack"
                                    className={`border-2 border-amber-300 bg-[#FEE8B6] p-2 rounded-lg w-full inline-block mt-1 mb-3 ${errors.snack ? "focus-visible:outline-2 focus-visible:outline-red-500" : ""}`}
                                />
                                <p className="text-red-500 mb-1 text-xs">
                                    {errors.snack?.message}
                                </p>
                            </div>
                            <button
                                type="submit"
