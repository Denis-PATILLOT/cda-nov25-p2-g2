      ...
      <Layout pageTitle="Staff - conversations">
        <div className="max-w-full mx-auto md:max-w-[1000px]">
          ...
          <div className="w-[90%] p-4 bg-[#FEF9F6] rounded-2xl text-[#1b3c79] font-semibold text-center border-3 min-h-[600px] border-[#FFD771] mx-auto">
              ...
              <Link href="/staff/conversations/create" className="opacity-70 hover:opacity-100 hover:underline" title="créer une conversation">
              ...
              <div className="flex w-full flex-wrap justify-start gap-3 mt-5">
                ...
                .map(conversation => 
                <Link key={conversation.id}  href={`/staff/conversations/${conversation.id}`} className="w-[90%] bg-[#FEF9F6] border-[#FFD771] border-2 mx-auto rounded-2xl p-1 cursor-pointer hover:bg-[#FFD888]">
                    <div>
