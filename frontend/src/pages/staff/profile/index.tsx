          ...
          <div className="w-[90%] p-4 bg-[#FEF9F6] rounded-4xl border-3 border-[#FFD771] mx-auto my-5 flex flex-col items-center justify-evenly">
            <div className="text-xs self-end">
              <button
                type="button"
                title="Déconnexion"
                className="cursor-pointer border-2 border-[#FFD771] text-[#1b3c79] rounded-2xl p-1 hover:bg-[#FFD771]"
            ...
            <input
              type="text"
              title="nom"
              className="w-[90%] my-3 px-2 border-2 border-[#FFD771] text-[#1b3c79] rounded-md"
