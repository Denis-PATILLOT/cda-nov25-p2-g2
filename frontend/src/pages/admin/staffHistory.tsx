      ...
      <div className="mx-auto w-full max-w-[420px] px-4 pt-2 pb-6 md:max-w-none md:px-16 md:pt-0 lg:px-24">
        <div className="relative flex items-center justify-between md:mt-20">
          ...
          <button
            ...
            className="rounded-2xl bg-white/80 border-2 border-(--color-secondary) px-2 py-1 text-[12px] cursor-pointer shadow-sm transition-all duration-200 hover:shadow-md hover:scale-[1.03] active:scale-95 md:px-6 md:py-3 md:text-[17px] md:rounded-3xl"
          >
            + Ajouter un membre
          </button>
        </div>
                ...
                >
                  ...
                  <div ref={openMenuId === menuKey ? menuRef : null} className="md:relative">
                    <button
                      ...
                      className="text-[20px] px-2 opacity-60 cursor-pointer cursor-pointer hover:opacity-100 md:text-[28px]"
                    >
                      •••
                    </button>
                    ...
                    {openMenuId === menuKey && (
                      <div className="absolute right-3 top-12 z-20 flex flex-col rounded-2xl bg-white border-2 border-(--color-tertiary) shadow-md overflow-hidden text-[13px] min-w-[140px] md:right-0 md:top-full md:mt-1 md:text-[16px] md:min-w-[180px]">
                        ...
                        <button
                          ...
                          className="flex items-center gap-3 px-4 py-2.5 cursor-pointer text-left text-red-500 hover:bg-red-50"
                        >
                          <TrashIcon />
                          Supprimer
                        </button>
