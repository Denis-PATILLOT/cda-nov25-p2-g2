    ...
    <Layout pageTitle="Modifier fiche parents - Admin">
      ...
      <div className="mx-auto w-full max-w-[420px] px-4 pt-2 pb-10">
          ...
          <div className="mt-4 rounded-2xl bg-white/80 border-2 border-(--color-secondary) px-4 py-3 shadow-md flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                ...
                <button type="button" onClick={() => setEditingField(editingField === "name" ? null : "name")}>
                  <PencilIcon />
                </button>
              </div>
              ...
              >
                ...
                <button type="button" onClick={() => setEditingField(editingField === "email" ? null : "email")}>
                  <PencilIcon />
                </button>
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <button type="button" onClick={() => setEditingField(editingField === "phone" ? null : "phone")}>
                  <PencilIcon />
                </button>
              </div>
            </div>
        ...
        <div className="mt-7">
          ...
          <button
            type="button"
            className="mt-4 w-full rounded-xl border-2 border-(--color-primary) bg-white py-2 text-[13px] shadow-sm transition-all duration-200 hover:shadow-md hover:scale-[1.03] active:scale-95"
          >
            Archiver
          </button>
        </div>
