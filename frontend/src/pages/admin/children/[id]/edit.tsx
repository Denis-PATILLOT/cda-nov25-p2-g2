...
export default function EditChildPage() {
    ...
    const selectedGroupName =
        groupsData?.getAllGroups.find((g) => Number(g.id) === selectedGroupId)
            ?.name ?? "—";
                ...
                <div className="mx-auto w-full max-w-[420px] px-4 pt-2 pb-10 md:max-w-none md:px-16 lg:px-24">
                    ...
                    <div className="mb-2 md:mt-20">
                        <button
                            type="button"
                            onClick={() =>
                                router.push("/admin/childrenHistory")
                            }
                            className="p-0"
                        >
                        ...
                        {editingField === "photo" ? (
                            ...
                            >
                                <input
                                    ...
                                    className="w-full rounded-lg border-2 border-(--color-primary) px-2 py-0.5 text-[14px] outline-none text-center md:w-full md:text-[18px]"
                                />
                            </div>
                        ) : (
                            ""
                            ...
                            {editingField === "name" ? (
                                ...
                                <>
                                    <span className="text-[16px] font-semibold md:text-[26px]">
                                        {firstNameVal || child?.firstName}{" "}
                                        {lastNameVal || child?.lastName}
                                    </span>
                                    <button
                                        type="button"
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-2 flex gap-2 justify-start">
                                            ...
                                            <button
                                                ...
                                                onClick={() =>
                                                    router.push(
                                                        `/admin/parents/${p.id}/edit?childId=${childId}`,
                                                    )
                                                }
